...
class RecipeData {
  static List<Recipe> recipes = [
    Recipe(
      ...
      imageAsset: 'assets/images/carbonara.jpg', // Asset path
      category: 'Pasta',
      prepTime: 15,
      cookTime: 20,
      difficulty: 'Medium',
    ...
    Recipe(
      ...
      imageAsset: 'assets/images/buddha_bowl.jpg', // Asset path
      category: 'Healthy',
      prepTime: 15,
      cookTime: 20,
      difficulty: 'Easy',
    ...
    Recipe(
      ...
      imageAsset: 'assets/images/avocado_pasta.jpg', // Asset path
      category: 'Pasta',
      prepTime: 10,
      cookTime: 15,
      difficulty: 'Easy',
    ...
    Recipe(
      ...
      imageAsset: 'assets/images/vegan_cake.jpg', // Asset path
      category: 'Dessert',
      prepTime: 20,
      cookTime: 35,
      difficulty: 'Medium',
